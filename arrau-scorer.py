...
def main():
    ...
    evaluate(key_directory, sys_directory, metrics, keep_singletons, keep_non_referring, use_MIN)

def evaluate(key_directory, sys_directory, metrics, keep_singletons, keep_non_referring, use_MIN):
